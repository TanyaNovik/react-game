...
export const setLocalStorageGame = async (sudoku: ISudoku[][], moves: number) => {
  await localStorage.setItem('currentGame', JSON.stringify({sudoku: JSON.stringify(sudoku), moves}))
}
